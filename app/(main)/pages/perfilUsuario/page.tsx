...
import { PerfilUsuariosService } from '@/service/PerfilUsuariosService';
...
const PerfilUsuario = () => {
    ...
    const perfilUsuarioService = useMemo(() => new PerfilUsuariosService(), []);
    ...
    const deleteSelectedPerfilsUsuario = () => {
        Promise.all(
            selectedPerfilsUsuario.map(async (_perfilUsuario) => {
                if (_perfilUsuario.id) {
                    await perfilUsuarioService.deletar(_perfilUsuario.id);
                }
            })
        )
            .then((response) => {
